...
//  InspoQuotes
//
//  Created by Mehmet Eroğlu on 13.04.2020.
...
class QuoteTableViewController: UITableViewController, SKPaymentTransactionObserver {
    ...
    // We took this productID from appstoreconnect In-App Purchases Features section (we write this productID in appstoreconnect)
    let productID = "com.Meroglu.InspoQuotes.PremiumQuotes"
